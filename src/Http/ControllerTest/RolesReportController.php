...
class RolesReportController extends Controller
{
    ...
    public function reports(){
        ...
        $users = DB::table(config('roles_dept.usersTables.tablename'))
        ->select(config('roles_dept.usersTables.tablename').'.'.config('roles_dept.usersTables.userIdColumn'),config('roles_dept.deptTable.tablename').'.'.config('roles_dept.deptTable.deptIdColumn'),config('roles_dept.usersTables.firstnameColumn'),config('roles_dept.usersTables.middlenameColumn'),config('roles_dept.usersTables.lastnameColumn'),config('roles_dept.deptTable.tablename').'.'.config('roles_dept.deptTable.nameColumn').' as unit',config('roles_dept.rolesTable.tablename').'.'.config('roles_dept.rolesTable.nameColumn').' as rolename',config('roles_dept.rolesTable.tablename').'.'.config('roles_dept.rolesTable.roleIdColumn'))
        ...
        $users = DB::table(config('roles_dept.usersTables.tablename'))
        ->select(config('roles_dept.usersTables.tablename').'.'.config('roles_dept.usersTables.userIdColumn').' as userId',config('roles_dept.usersTables.firstnameColumn'),config('roles_dept.usersTables.middlenameColumn'),config('roles_dept.usersTables.lastnameColumn'),config('roles_dept.deptTable.tablename').'.'.config('roles_dept.deptTable.nameColumn').' as unit',config('roles_dept.rolesTable.tablename').'.'.config('roles_dept.rolesTable.nameColumn').' as rolename',DB::raw('CONCAT('.config('roles_dept.permissionTable.tablename').'.'.config('roles_dept.permissionTable.labelColumn').') as permission'))
